package harnina.model.accessDB;
...
public class AccessMysql {
    ...
    public static AccessMysql instance(String bbdd, String user, String password) throws SQLException, ClassNotFoundException {
        if (accessMysql != null) {
            System.out.println(accessMysql.user);
            if (!AccessMysql.bbdd.equals(bbdd)
                    || !AccessMysql.user.equals(user)
                    || !AccessMysql.password.equals(password)
            ) {
                connection.close();
    ...
    private static void createInstance(String bbdd, String user, String password) throws ClassNotFoundException, SQLException {
