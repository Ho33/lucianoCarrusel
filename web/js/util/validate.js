STORE.namespace("STORE.validateUtil");
STORE.validateUtil = {
    ...
    addLimitPattern: function (params) {
        ...
        if (params.limite.limiteInferior > 0 && params.limite.limiteSuperior > 0) {
            ...
            params.patron += "{" + params.limite.limiteInferior + "," + params.limite.limiteSuperior + "})$";

            params.mensajeError += " ; entre " + params.limite.limiteInferior + ", " + params.limite.limiteSuperior;
    ...
    callAssessConsequences: function (params) {
        STORE.validateUtil.assessConsequences(STORE.validateUtil.execExpRegular(params.patron, params.nodo.value), params);
    }
};

STORE.namespace("STORE.validate");
STORE.validate = {
